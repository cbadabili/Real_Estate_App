 ...
 * Implements Pillar 3: Integrated Affordability & Finance Centre
 * Pre-populated with Bank of Botswana rates and local bank terms
 * Addresses market anxiety about property affordability
 */
export const MortgageCalculator: React.FC<MortgageCalculatorProps> = ({
  ...
  const [activeTab, setActiveTab] = useState<'calculate' | 'afford'>('calculate');
