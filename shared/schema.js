...
import { pgTable, text, integer, boolean, real, doublePrecision, numeric, timestamp, jsonb, serial, varchar, customType, } from "drizzle-orm/pg-core";
...
export const properties = pgTable("properties", {
    ...
    price: numeric("price", { precision: 12, scale: 2 }).$type().notNull(),
    ...
    images: jsonb("images").$type().default(sql `'[]'::jsonb`).notNull(),
    features: jsonb("features").$type().default(sql `'[]'::jsonb`).notNull(),
...
(function (Permission) {
    ...
    Permission["VIEW_PROPERTY"] = "view_property";
    Permission["FEATURE_PROPERTY"] = "feature_property";
    Permission["APPROVE_PROPERTY"] = "approve_property";
    // Review management
    Permission["CREATE_REVIEW"] = "create_review";
    Permission["UPDATE_REVIEW"] = "update_review";
    Permission["DELETE_REVIEW"] = "delete_review";
    Permission["VIEW_REVIEW"] = "view_review";
    Permission["MODERATE_REVIEW"] = "moderate_review";
    Permission["RESPOND_TO_REVIEW"] = "respond_to_review";
    // User management
    Permission["VERIFY_USER"] = "verify_user";
    Permission["BAN_USER"] = "ban_user";
    Permission["DELETE_USER"] = "delete_user";
    // Admin operations
    Permission["VIEW_ADMIN_PANEL"] = "view_admin_panel";
    ...
    Permission["APPROVE_SERVICE_PROVIDER"] = "approve_service_provider";
    // Billing
    Permission["MANAGE_BILLING"] = "manage_billing";
    Permission["VIEW_PAYMENTS"] = "view_payments";
    Permission["APPROVE_PAYMENTS"] = "approve_payments";
