...
export function registerPropertyRoutes(app) {
    ...
    app.get("/api/properties", async (req, res) => {
        try {
            const filters = {
                ...
                location: req.query.location, // Add location search parameter
    ...
    // Get single property
    app.get("/api/properties/:id", optionalAuthenticate, async (req, res) => {
        try {
    ...
    app.post("/api/properties", authenticate, async (req, res) => {
        try {
            ...
            const { areaText, placeName, placeId, latitude, longitude, locationSource, features, images, ...rest } = req.body;
